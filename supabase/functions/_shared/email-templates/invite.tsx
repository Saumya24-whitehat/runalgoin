    ...
    <Body style={body}>
      <Container style={wrapper}>
        ...
        <Container style={card}>
          ...
          <Text style={lead}>
            You've been invited to join <strong>{siteName}</strong>. Accept your invite to create your account and start exploring pro-grade options analytics.
          </Text>
          <Section style={{ textAlign: 'center', margin: '32px 0' }}>
            <Button style={cta} href={confirmationUrl}>Accept invite</Button>
          </Section>
          <Text style={muted}>
          ...
          <Hr style={hr} />
          <Text style={muted}>
            {recipient ? <>Invited: <strong>{recipient}</strong>. </> : null}
