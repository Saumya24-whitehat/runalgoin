    ...
    },
    {
      ...
      constructor: function () {
        ((this.init = function (context, inputData) {
          ((this._context = context), (this._input = inputData));
        }),
          (this.main = function (ctx, inputVals) {
            // try {
            const patterns = new Array(46).fill(NaN);
            ((this._context = ctx), (this._input = inputVals));
            ...
            if (filterType === smaFifty) {
              ...
              ((bearishTrend = closePrice < sma50 && sma50 < sma200),
                ...
                bearishSignal.set(bearishTrend ? 1 : 0),
                bullishSignal.set(bullishTrend ? 1 : 0));
            } else (bearishSignal.set(1), bullishSignal.set(1));
            ...
            const emaPeriod = 14,
              ...
              shadowBalance =
                upperShadow === lowerShadow || (upperRatio < balancePercent && lowerRatio < balancePercent),
            ...
            if (this._input(4)) {
              !dojiPattern ||
                (isSmallBody && upperShadow <= bodySize) ||
                (isSmallBody && lowerShadow <= bodySize) ||
                (patterns[3] = 1);
            }
            ...
            if (this._input(6) && enableBearish) {
              ...
              largePrev2 &&
                ...
                bearFilter &&
                redPrev2 &&
                upperPrev1 < lowerPrev2 &&
                redPrev1 &&
                greenCandle &&
                upperBound <= lowerPrev2 &&
                upperBound >= upperPrev1 &&
                (patterns[6] = 1);
            }
            ...
            if (this._input(9) && enableBearish) {
              ...
              largePrev2 &&
                ...
                bullFilter &&
                greenPrev2 &&
                lowerPrev1 > upperPrev2 &&
                isRed &&
                lowerCurr <= midPrev2 &&
                lowerCurr > lowerPrev1 &&
                lowerPrev1 > upperPrev2 &&
                (patterns[10] = 1);
            }
            if (this._input(10) && enableBearish) {
              ...
              largePrev2 &&
                ...
                isRed &&
                lowerCurr <= midPrev2 &&
                lowerCurr > lowerPrev2 &&
                lowerPrev1 > upperCurr &&
                (patterns[11] = 1);
            }
            ...
            if (this._input(14) && enableBullish) {
              smallBody &&
                bodySize > 0 &&
                lowerBound > (highPrice + lowPrice) / 2 &&
                lowerShadow >= multiplier * bodySize &&
                !longUpperShadow &&
                bearishTrend &&
                (patterns[15] = 1);
            }
            ...
            if (this._input(18) && enableBullish) {
              ...
              smallBody &&
                bodySize > 0 &&
                upperBound < (highPrice + lowPrice) / 2 &&
                upperShadow >= multiplier * bodySize &&
                !longLowerShadow &&
                bearishTrend &&
                (patterns[21] = 1);
            }
            ...
            if (pattern19Enabled && enableBullish) {
              const threshold = 5,
                conditions =
                  largeBody &&
                  highPrice - upperBound <= (threshold / 100) * bodySize &&
                  lowerBound - lowPrice <= (threshold / 100) * bodySize &&
                  greenCandle,
              ...
              conditions &&
                largePrev &&
                highDiff <= (threshold / 100) * bodyPrev &&
                lowDiff <= (threshold / 100) * bodyPrev &&
                redPrev &&
                highVar.get(1) < lowPrice &&
                (patterns[22] = 1);
            }
            ...
            if (this._input(22) && enableBearish) {
              ...
              redCandle &&
                largeBody &&
                upperShadow <= (threshold / 100) * bodySize &&
                lowerShadow <= (threshold / 100) * bodySize &&
                (patterns[26] = 1);
            }
            ...
            if (this._input(24) && enableBullish) {
              ...
              largePrev2 &&
                ...
                isGreen &&
                upperCurr >= midPrev2 &&
                upperCurr < upperPrev2 &&
                upperPrev1 < lowerBound &&
                (patterns[28] = 1);
            }
            ...
            if (this._input(33) && enableBearish) {
              ...
              isLarge &&
                ...
                redPrev1 &&
                redPrev2 &&
                (rangeCurr * threshold) / 100 > lowerCurr &&
                (rangePrev1 * threshold) / 100 > lowerPrev1 &&
                (rangePrev2 * threshold) / 100 > lowerPrev2 &&
                closeCurr < closePrev1 &&
                closePrev1 < closePrev2 &&
                openCurr > closePrev1 &&
                openCurr < openPrev1 &&
                openPrev1 > closePrev2 &&
                openPrev1 < openPrev2 &&
                (patterns[37] = 1);
            }
            if (this._input(34) && enableBullish) {
              ...
              isLarge &&
                ...
                greenPrev1 &&
                greenPrev2 &&
                (rangeCurr * threshold) / 100 > upperCurr &&
                (rangePrev1 * threshold) / 100 > upperPrev1 &&
                (rangePrev2 * threshold) / 100 > upperPrev2 &&
                closeCurr > closePrev1 &&
                closePrev1 > closePrev2 &&
                openCurr < closePrev1 &&
                openCurr > openPrev1 &&
            ...
            if (pattern35Enabled && enableBullish) {
              ...
              currentDoji &&
                ...
                dojiPrev2 &&
                bearFilter2 &&
                lowerPrev2 > upperPrev1 &&
                upperPrev1 < lowerCurr &&
                (patterns[39] = 1);
            }
            if (pattern35Enabled && enableBearish) {
              ...
              currentDoji &&
                ...
                dojiPrev2 &&
                bullFilter2 &&
                upperPrev2 < lowerPrev1 &&
                lowerCurr > upperPrev1 &&
                (patterns[40] = 1);
            }
            if (this._input(36) && enableBullish) {
              const bearFilter = bearishSignal.get(1),
                ...
                lowBalance = Math.abs(lowCurr - lowPrev) <= 0.05 * emaBody,
                redPrev = redVar.get(1),
                isGreen = greenCandle,
                largePrev = largeBodyVar.get(1);
              bearFilter &&
                (!smallCurr || (longUpper && longLower)) &&
                lowBalance &&
                redPrev &&
                isGreen &&
                largePrev &&
            ...
            if (this._input(37) && enableBearish) {
              const bullFilter = bullishSignal.get(1),
                ...
                highPrev = highVar.get(1),
                highBalance = Math.abs(highCurr - highPrev) <= 0.05 * emaBody,
                greenPrev = greenVar.get(1),
                isRed = redCandle,
                largePrev = largeBodyVar.get(1);
              bullFilter &&
            ...
            if (this._input(38) && enableBullish) {
              ...
              largePrev2 &&
                ...
                redCandle &&
                lowerPrev1 > upperPrev2 &&
                lowerBound >= upperPrev2 &&
                lowerBound <= lowerPrev1 &&
                (patterns[43] = 1);
            }
            return patterns;
          }));
...

    {
      ...
      constructor: function () {
        this.main = function (context, inputCallback) {
          ...
          var time = PineJS.Std.time(this._context);
          var inputsStr = [];
          var name = "Open Interest Indicator (" + inputsStr.join(",") + ")";
          if (studies) {
            if (studies[name]) {
              studies[name][time] = openInterest;
            } else {
              studies[name] = {};
              studies[name][time] = openInterest;
            }
    ...
    // Day Money Flow Joint Indicator
    {
      ...
      constructor: function () {
        ...
        this.calculateEMA = function (value, valuesArray, length) {
          ...
          const previousEMA = valuesArray.length > 1 ? valuesArray[valuesArray.length - 2] : value;
