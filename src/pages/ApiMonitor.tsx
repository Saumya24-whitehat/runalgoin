...
const API_CONFIGS: ApiConfig[] = [
  ...
  { name: "Future Buildup", edgeFunction: "future-buildup", body: { symbol: "Nifty 50" }, needsExpiry: true },
  { name: "Future Open/High/Low", edgeFunction: "future-open-high-low", body: { symbol: "Nifty 50" }, needsExpiry: true },
  { name: "Future Rollover", edgeFunction: "future-rollover", body: { symbol: "Nifty 50" }, needsExpiry: true },
