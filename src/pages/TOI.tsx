                ...
                >
                  <SelectTrigger className="h-7 w-[100px] text-xs bg-secondary">
                    <SelectValue placeholder="Time">
                      {currentTimeData ? currentTimeData.Time : "Time"}
                    </SelectValue>
                  </SelectTrigger>
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-muted/30">
                      <TableHead rowSpan={2} className="text-center border-r border-border/50 align-middle">Time</TableHead>
                      <TableHead rowSpan={2} className="text-center border-r border-border/50 align-middle">Spot Price</TableHead>
                      <TableHead colSpan={4} className="text-center text-call border-r border-border/50 bg-emerald-500/10">CALL</TableHead>
                      <TableHead colSpan={4} className="text-center text-put border-r border-border/50 bg-red-500/10">PUT</TableHead>
                      <TableHead colSpan={2} className="text-center border-r border-border/50">PCR</TableHead>
                      <TableHead colSpan={2} className="text-center border-r border-border/50">DIFF</TableHead>
                      <TableHead rowSpan={2} className="text-center align-middle">TREND</TableHead>
                    </TableRow>
                    <TableRow className="bg-muted/30">
                  ...
                  <TableBody>
                    {[...toiData].reverse().map((entry, idx) => (
                      ...
                      >
                        <TableCell className="text-center font-medium border-r border-border/50">{entry.Time}</TableCell>
                        <TableCell className="text-center border-r border-border/50">{entry.Spot_Price?.toFixed(2)}</TableCell>
                        ...
                        <TableCell className="text-center text-call border-r border-border/50">{formatNumber(entry.CE_VOLUME)}</TableCell>
                        ...
                        <TableCell className="text-center text-put border-r border-border/50">{formatNumber(entry.PE_VOLUME)}</TableCell>
                        
                        {/* PCR */}
                        <TableCell className="text-center">{formatPCR(entry.PCR_COI)}</TableCell>
                        <TableCell className="text-center border-r border-border/50">{formatPCR(entry.PCR_OI)}</TableCell>
                        
                        {/* DIFF */}
                        <TableCell className={`text-center ${getColorClass(entry.CE_OI_CHANGE)}`}>
                          {formatNumber(entry.CE_OI_CHANGE)}
                        </TableCell>
                        <TableCell className={`text-center border-r border-border/50 ${getColorClass(entry.PE_OI_CHANGE)}`}>
          ...
          <Card className="bg-card/50 border-border/50">
            <CardContent className="py-20 text-center">
              <p className="text-muted-foreground">
                Select symbol, expiry, and strikes, then click GO to load data
              </p>
            </CardContent>
          </Card>
        )}
